...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.bumpStaging = exports.bumpProduction = void 0;
const semver_1 = __nccwpck_require__(1383);
function bump(semver, config) {
    return semver.inc(config.bumpType);
}
function bumpProduction(config) {
    const productionSemVer = (0, semver_1.parse)(config.productionVersion);
    if (productionSemVer === null) {
        throw Error(`Could not parse SemVer ${config.productionVersion}`);
    }
    return bump(productionSemVer, config);
}
exports.bumpProduction = bumpProduction;
function bumpStaging(config) {
    const productionSemVer = (0, semver_1.parse)(config.productionVersion);
    if (productionSemVer === null) {
        throw Error(`Could not parse SemVer ${config.productionVersion}`);
    }
    const stagingSemVer = (0, semver_1.parse)(config.stagingVersion);
...
exports.configSchema = zod_1.default
    .object({
